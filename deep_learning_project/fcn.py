...
def fcn_8(n_classes, encoder=vanilla_encoder, input_height=416, input_width=608, channels=3):
    ...
    o = Conv2DTranspose(n_classes, kernel_size=(16, 16), strides=(8, 8), use_bias=False, data_format='channels_last')(o)
...
def fcn_32(n_classes, encoder=vanilla_encoder, input_height=416, input_width=608, channels=3):
    ...
    o = (Conv2D(n_classes,  (1, 1), kernel_initializer='he_normal', data_format='channels_last', name='seg_feats'))(o)
    o = Conv2DTranspose(n_classes, kernel_size=(64, 64),  strides=(32, 32), use_bias=False,  data_format='channels_last')(o)
...
def fcn_8_vgg(n_classes, input_height=416, input_width=608, channels=3):
    model = fcn_8(n_classes, get_vgg_encoder, input_height=input_height, input_width=input_width, channels=channels)
    model.model_name = 'fcn_8_vgg'
    return model

def fcn_32_vgg(n_classes, input_height=416, input_width=608, channels=3):
    model = fcn_32(n_classes, get_vgg_encoder, input_height=input_height, input_width=input_width, channels=channels)
    model.model_name = 'fcn_32_vgg'
    return model

def fcn_8_resnet50(n_classes, input_height=416, input_width=608, channels=3):
    model = fcn_8(n_classes, get_resnet50_encoder, input_height=input_height, input_width=input_width, channels=channels)
    model.model_name = 'fcn_8_resnet50'
    return model

def fcn_32_resnet50(n_classes, input_height=416, input_width=608, channels=3):
    model = fcn_32(n_classes, get_resnet50_encoder, input_height=input_height, input_width=input_width, channels=channels)
...
def fcn_32_mobilenet(n_classes, input_height=224, input_width=224, channels=3):
    model = fcn_32(n_classes, get_mobilenet_encoder, input_height=input_height, input_width=input_width, channels=channels)
